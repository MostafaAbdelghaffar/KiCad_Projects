...
The first one "StopLight" is meant to be familiar with the KiCad tool as the training that I had was on Altium. It is a simple pcb design with 3 LEDs and 3 Resistors and a connector.
